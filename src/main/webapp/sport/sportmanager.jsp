...
<title>Sport Management</title>
	<%
		List<SportDTO> listSport = (List<SportDTO>) request.getAttribute("sport");
	 %>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
		...
		<tr><th>Id</th><th>Name</th><th>Players</th>
		<%
			for(SportDTO user: listSport){
		 %>
		 	<tr>
		 		<td><%=user.getId()%></td>
		 		<td><%=user.getName()%></td>
		 		<td><%=user.getPlayers()%></td>
		 		
		 		<td><a class="btn btn-primary btn-lg btn-block" href="/Sport/deleteSport?id=<%=user.getId() %>">Delete</a></td>
		 		<td><a class="btn btn-primary btn-lg btn-block"href="/Sport/redirectUpdate?id=<%=user.getId()%>">Update</a></td>
		 	</tr>
		<% 
			}
		%>
