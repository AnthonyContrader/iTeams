...
import { EventUpdateComponent } from 'app/entities/micro1/event/event-update.component';
import { EventService } from 'app/entities/micro1/event/event.service';
import { Event } from 'app/shared/model/micro1/event.model';
